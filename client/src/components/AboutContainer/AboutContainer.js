                    ...
                    laborum."
                      ...
                      <div className="col-12 iconHold">
                        <a href="https://www.linkedin.com/in/dorian-crawford-659482115/" target="_blank" rel="noopener noreferrer">
                            LinkedIn<img alt="" className="icon" src='./images/LinkedIn.png' />
                        </a>
                        <a href="https://github.com/dc887j" target="_blank" rel="noopener noreferrer">
                            GitHub<img alt="" className="icon" src='./images/gitHub.png' />
                        </a>
                        <a href="mailto:dc887j@gmail.com" target="_blank" rel="noopener noreferrer">
                            Email<img alt="" className="icon" src='./images/email.png' />
                        </a>
                    </div>
                </p>
            </div>
        ...
        <div className="row">
            <div className="col-12">
                ...
                <p>
                    ...
                    <div className="col-12 iconHold">
                        <a href="https://www.linkedin.com/in/dorian-crawford-659482115/" target="_blank" rel="noopener noreferrer">
                            <img alt="" className="icon" src='./images/LinkedIn.png' />
                        </a>
                        <a href="https://github.com/dc887j" target="_blank" rel="noopener noreferrer">
                            <img alt="" className="icon" src='./images/gitHub.png' />
                        </a>
                        <a href="https://www.youtube.com/watch?v=ViUO7BNmcr0" target="_blank" rel="noopener noreferrer">
                            <img alt="" className="icon" src='./images/YouTube.png' />
                        </a>
                        <a href="mailto:dc887j@gmail.com" target="_blank" rel="noopener noreferrer">
                            <img alt="" className="icon" src='./images/email.png' />
                        </a>
                    </div>
                </p>
            </div>
            ...
            <div className="col-12">
                ...
                <p>
                    ...
                    <div className="col-12 iconHold">
                        ...
                        <img alt="" className="icon" src='./images/gitHub.png' />
                        <img alt="" className="icon" src='./images/YouTube.png' />
                        <img alt="" className="icon" src='./images/Google.png' />
                        <img alt="" className="icon" src='./images/email.png' />
